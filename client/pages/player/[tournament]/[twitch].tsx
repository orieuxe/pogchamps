import { Box, Button, Link, SimpleGrid, Tooltip } from '@chakra-ui/react'
		...
		<SimpleGrid minChildWidth={310} spacing={10}>
			<Box>
				<SimpleGrid minChildWidth={100} spacing={2}>
					<Box>
						<MyImage src={`/players/${player.twitch}.png`} width={200}></MyImage>
					</Box>
					<Box style={{ fontSize: '1.2em' }}>
						...
						{participant.groupe && (
              <Link href={`/group/${selectedTournament}/${participant.groupe}`}  style={{ textDecoration: 'none' }}>
